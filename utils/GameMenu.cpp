...
void GameMenu::init() {
    ...
    buttonMap["settings"] = new Button(
        "settings", "../assets/fonts/ManilaSansBld.otf", 50, std::bind(&changeState, this, SETTINGS), this->windowWidth, this->windowHeight, this->windowWidth/2.2, this->windowHeight/1.65
    );
    buttonMap["exit"] = new Button(
        "exit", "../assets/fonts/ManilaSansBld.otf", 50, std::bind(&changeState, this, EXIT), this->windowWidth, this->windowHeight, this->windowWidth/2.2, this->windowHeight/1.4
    );
